...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Calculate the solution to the 1-dimensional Schroedinger equation for a given Potential.')
    parser.add_argument('-i', '--input', type=str, required=False, help='Path to the schroedinger.inp file')
    parser.add_argument('-o', '--output', type=str, required=False,  help='Directory of the output files.')
   ...
   #saving results to files
    in_out.output(potential, energies, psi, x_exp, sigma_x, xnew, params['first'], params['last'], args.output)
